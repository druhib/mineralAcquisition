...
function PerformanceWatchdogViewModel(options) {
  if (!defined22(options) || !defined22(options.scene)) {
...
import { defined as defined26, Event as Event3 } from "@cesium/engine";
...
function InfoBoxViewModel() {
  ...
  knockout_default.defineProperty(this, "_bodyless", {
    get: function() {
      return !defined26(this.description) || this.description.length === 0;
    }
  });
}
      ...
      function(value) {
        ...
        if (firstElementChild !== null && frameContent.childNodes.length === 1) {
          ...
          if (style !== null) {
            ...
            if (defined27(color) && color.alpha !== 0) {
...
InfoBox.prototype.destroy = function() {
  ...
  if (defined27(this._descriptionSubscription)) {
