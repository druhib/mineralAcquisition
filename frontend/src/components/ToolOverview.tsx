                ...
                <div className="inner" >
                    ...
                    <header style = {{ textAlign:'left' ,color:'#000000ff'}}>
                            ...
                            <p><strong>Home Page</strong></p> 
                                ...
                                <p>On the home page, you will find an interactive, color coded map that shows which countries have exported a given material over a given time period.
                                ...
                                the British Geological Survey (1913-2019), and the United States Geological Survey (1495-1900). Each one of these mineral commodity surveys report on the production of 40 different items.
                                Due to time constraints, the authors constrained the scope of this work to 10 of the most important and widely used materials of the modern age. </p>
                            ...
                            <p><strong>What is mining?</strong></p>
